...
<head>
    ...
    <link href="{{ asset('assets/css/demo_rev.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/font/font-awesome-4.2.0/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/css/menu_wave_rev.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
